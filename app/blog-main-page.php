...
<body>
    <div class="content">
        ...
        <div class="log-out">
            <a class="log-out-a" href="log-out.php"><button style="position:relative; left:5px; top:10px; 
            background-color: #f35345; 
            font-size:24px; border-radius: 5px; ">Log out</button></a>
        </div>
        <div class="wall" style="position: relative; width: 98%; margin: auto; border-radius: 5px; 
        border-color: #f35345; border-style: solid; height:845px; top:15px; overflow: auto;">
            <?php
            include 'user.php';
            user::getUserPosts($username);
            ?>
        </div>
    </div>
</body>
